...
public class CaptchaCode implements InitializingBean {
	...
	private static final String DEFAULT_COOKIE_NAME = "neusoft-captcha";
	private final static String DEFAULT_CHACHE_NAME = "neusoftCaptchaCache";
	...
	private Cache<String, String> neusoftCaptchaCache;
	...
	public void afterPropertiesSet() throws Exception {
		...
		this.neusoftCaptchaCache = cacheManager.getCache(cacheName);
	}
	...
	public void generate(HttpServletRequest request, HttpServletResponse response) {
		...
		neusoftCaptchaCache.put(cookieValue, captchaCode);
	}
	...
	public boolean validate(HttpServletRequest request, HttpServletResponse response, String userInputCaptcha) {
		...
		String captchaCode = neusoftCaptchaCache.get(cookieValue);
		...
		if (result) {
			neusoftCaptchaCache.remove(cookieValue);
