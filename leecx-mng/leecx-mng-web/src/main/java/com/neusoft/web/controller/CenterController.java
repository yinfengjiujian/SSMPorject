...
import com.neusoft.web.utils.CaptchaCode;
...
import com.neusoft.common.utils.NumberUtil;
import com.neusoft.pojo.SysUser;
import com.neusoft.service.UserService;
import com.neusoft.web.shiro.ShiroPasswordUtil;
...
public class CenterController extends BaseController {
    ...
    public void captcha(HttpServletRequest request, HttpServletResponse response) {
        captchaCode.generate(request, response);
    }
    ...
    public String logout(HttpServletRequest request, HttpServletResponse response) {
        ...
        // 主体用户退出
        subject.logout();
        //采用 redirect 重定向地址服务，默认采用 RequestMethod.GET 发起请求！
